...
export function AuthPage() {
  const { sendMagicLink, signInWithPassword, signUp, isAuthenticated, isLoading, error, clearError } = useAuth();
          ...
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-8 shadow-2xl shadow-purple-900/50 animate-slide-up">
            <div className="text-center mb-6">
              ...
              <h2 className="text-3xl font-bold text-white mb-2">
                {authMode === 'signin' ? 'Welcome Back, Wizard' : 'Join the School'}
              </h2>
              <p className="text-purple-200/80">
                {authMode === 'signin' ? 'Sign in to your magical account' : 'Create your magical account'}
              </p>
            </div>
            ...
            <div className="flex mb-6 bg-white/5 rounded-xl p-1">
              <button
                ...
                className={`flex-1 py-2 px-4 rounded-lg text-sm font-medium transition-all ${authMode === 'signin'
              ...
              <button
                ...
                className={`flex-1 py-2 px-4 rounded-lg text-sm font-medium transition-all ${authMode === 'signup'
                  ? 'bg-purple-600 text-white shadow-lg'
                  : 'text-purple-200/70 hover:text-white'
                  }`}
              >
            ...
            <div className="flex mb-6 bg-white/5 rounded-xl p-1">
              <button
                ...
                className={`flex-1 py-2 px-4 rounded-lg text-sm font-medium transition-all ${authMethod === 'magic'
              ...
              <button
                ...
                className={`flex-1 py-2 px-4 rounded-lg text-sm font-medium transition-all ${authMethod === 'password'
                  ? 'bg-indigo-600 text-white shadow-lg'
                  : 'text-purple-200/70 hover:text-white'
                  }`}
              >
                ...
                <>
                  <div>
                    ...
                    <p className="mt-1 text-xs text-purple-200/70">
                      {authMode === 'signup' ? 'Minimum 6 characters' : 'Enter your account password'}
                    </p>
                  </div>
              ...
              <div className="mt-4 p-4 bg-green-500/20 border border-green-400/30 rounded-xl">
                ...
                {authMethod === 'magic' && (
                  <p className="text-center text-xs text-green-200/70 mt-2">
                    ...
                    {countdown > 0 ? (
                      <span className="text-amber-300">wait {countdown}s to try again</span>
                    ) : (
                      <button onClick={handleRetry} className="underline hover:text-green-100">
                        try again
                      </button>
                    )}
                  </p>
