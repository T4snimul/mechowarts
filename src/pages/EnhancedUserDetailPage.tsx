...
export function EnhancedUserDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-indigo-50/60 to-purple-100/40 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 pt-20 pb-12">
